...
import type { InternalClaimPlans } from '@signtusk/ee/server-only/stripe/get-internal-claim-plans';
...
import { parseMessageDescriptorMacro } from '@signtusk/lib/utils/i18n';
import { isPersonalLayout } from '@signtusk/lib/utils/organisations';
import { trpc } from '@signtusk/trpc/react';
import { ZCreateOrganisationRequestSchema } from '@signtusk/trpc/server/organisation-router/create-organisation.types';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-4 grid gap-4 text-sm">
        ...
        <Link
          to="https://signtusk.com/enterprise"
          target="_blank"
