...
import type { TCreateDocumentPayloadSchema } from '@signtusk/trpc/server/document-router/create-document.types';
import type { TCreateTemplatePayloadSchema } from '@signtusk/trpc/server/template-router/schema';
import { cn } from '@signtusk/ui/lib/utils';
import { DocumentUploadButton as DocumentUploadButtonPrimitive } from '@signtusk/ui/primitives/document-upload-button';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
