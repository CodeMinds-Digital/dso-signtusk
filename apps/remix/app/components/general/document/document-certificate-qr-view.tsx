...
import { type DocumentData, DocumentStatus, type EnvelopeItem, EnvelopeType } from '@signtusk/lib/constants/prisma-enums';
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                <Trans>
                  This document is available in your Signtusk account. You can view more details,
