...
import type { TLocalField } from '@signtusk/lib/client-only/hooks/use-editor-fields';
import { usePageRenderer } from '@signtusk/lib/client-only/hooks/use-page-renderer';
import { useCurrentEnvelopeEditor } from '@signtusk/lib/client-only/providers/envelope-editor-provider';
import { useCurrentEnvelopeRender } from '@signtusk/lib/client-only/providers/envelope-render-provider';
import { FIELD_META_DEFAULT_VALUES } from '@signtusk/lib/types/field-meta';
import {
  MIN_FIELD_HEIGHT_PX,
  MIN_FIELD_WIDTH_PX,
  convertPixelToPercentage,
} from '@signtusk/lib/universal/field-renderer/field-renderer';
import { renderField } from '@signtusk/lib/universal/field-renderer/render-field';
import { getClientSideFieldTranslations } from '@signtusk/lib/utils/fields';
import { canRecipientFieldsBeModified } from '@signtusk/lib/utils/recipients';
import { CommandDialog } from '@signtusk/ui/primitives/command';
