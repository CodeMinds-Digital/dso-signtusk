...
import { useCurrentEnvelopeEditor } from '@signtusk/lib/client-only/providers/envelope-editor-provider';
...
} from '@signtusk/lib/constants/document';
import {
  SUPPORTED_LANGUAGES,
...
import { isValidRedirectUrl } from '@signtusk/lib/utils/is-valid-redirect-url';
import {
...
import { DocumentEmailCheckboxes } from '@signtusk/ui/components/document/document-email-checkboxes';
import {
  DocumentGlobalAuthAccessSelect,
  DocumentGlobalAuthAccessTooltip,
} from '@signtusk/ui/components/document/document-global-auth-access-select';
import {
  DocumentGlobalAuthActionSelect,
  DocumentGlobalAuthActionTooltip,
} from '@signtusk/ui/components/document/document-global-auth-action-select';
import { DocumentSendEmailMessageHelper } from '@signtusk/ui/components/document/document-send-email-message-helper';
import { DocumentSignatureSettingsTooltip } from '@signtusk/ui/components/document/document-signature-settings-tooltip';
import {
  DocumentVisibilitySelect,
  DocumentVisibilityTooltip,
} from '@signtusk/ui/components/document/document-visibility-select';
import { cn } from '@signtusk/ui/lib/utils';
import { Button } from '@signtusk/ui/primitives/button';
import { CardDescription, CardHeader, CardTitle } from '@signtusk/ui/primitives/card';
import { Combobox } from '@signtusk/ui/primitives/combobox';
import {
  Dialog,
  DialogClose,
  DialogContent,
                              ...
                              <FormControl>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value={'-1'}>Signtusk</SelectItem>
                                  </SelectContent>
                                </Select>
                              </FormControl>
