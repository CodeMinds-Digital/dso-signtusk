...
import { DocumentSigningOrder, EnvelopeType, RecipientRole, SendStatus } from '@signtusk/lib/constants/prisma-enums';
...
import type { TDetectedRecipientSchema } from '@signtusk/lib/server-only/ai/envelope/detect-recipients/schema';
import {
...
import { canRecipientBeModified as utilCanRecipientBeModified } from '@signtusk/lib/utils/recipients';
...
import { RecipientActionAuthSelect } from '@signtusk/ui/components/recipient/recipient-action-auth-select';
import {
  RecipientAutoCompleteInput,
  type RecipientAutoCompleteOption,
} from '@signtusk/ui/components/recipient/recipient-autocomplete-input';
import { RecipientRoleSelect } from '@signtusk/ui/components/recipient/recipient-role-select';
...
import {
  ...
  CardHeader,
  CardTitle,
} from '@signtusk/ui/primitives/card';
import { Checkbox } from '@signtusk/ui/primitives/checkbox';
import { SigningOrderConfirmation } from '@signtusk/ui/primitives/document-flow/signing-order-confirmation';
import {
  Form,
  FormControl,
  FormField,
...
import { FormErrorMessage } from '@signtusk/ui/primitives/form/form-error-message';
