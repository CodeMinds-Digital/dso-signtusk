...
import timurImage from '@signtusk/assets/images/timur.png';
import { NEXT_PUBLIC_WEBAPP_URL } from '@signtusk/lib/constants/app';
import { VerifiedIcon } from '@signtusk/ui/icons/verified';
    ...
    >
      ...
      <div className="mt-4">
        <img
          ...
          alt="image of timur ercan founder of Signtusk"
        />
      </div>
