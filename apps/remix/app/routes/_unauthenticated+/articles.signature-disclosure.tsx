...
import { SUPPORT_EMAIL } from '@signtusk/lib/constants/app';
  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using Signtusk to perform your electronic document signing. The purpose
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by Signtusk, you affirm
