...
export interface BrandVariants {
    camelCase: { old: string; new: string };
    kebabCase: { old: string; new: string };
    pascalCase: { old: string; new: string };
    lowercase: { old: string; new: string };
    uppercase: { old: string; new: string };
    snakeCase: { old: string; new: string };
}
...
export interface PackageScopeMapping {
    oldScope: string;
    newScope: string;
    packageNames: string[];
}
 ...
 */
export const BRAND_MAPPING: BrandMapping = {
 ...
 */
export const PACKAGE_SCOPE_MAPPING: PackageScopeMapping = {
    oldScope: '@signtusk',
    newScope: '@signtusk',
    packageNames: [
        'root',
