...
// import { DOCUMENSO_INTERNAL_EMAIL } from '@signtusk/lib/constants/email';
...
export const sendOrganisationAccountLinkConfirmationEmail = async (props: SendOrganisationAccountLinkConfirmationEmailProps) => {
