...
import { validateDropdownField } from '@signtusk/lib/advanced-fields-validation/validate-dropdown';
import { validateNumberField } from '@signtusk/lib/advanced-fields-validation/validate-number';
import { validateTextField } from '@signtusk/lib/advanced-fields-validation/validate-text';
...
import type { TDocumentMeta } from '@signtusk/lib/types/document-meta';
import {
  ZCheckboxFieldMeta,
  ZDropdownFieldMeta,
  ZNumberFieldMeta,
...
import { toCheckboxCustomText, toRadioCustomText } from '@signtusk/lib/utils/fields';
    ...
    .with({ type: FieldType.DATE }, (fieldValue) => {
      ...
      return {
        customText: DateTime.now()
          .setZone((typeof documentMeta.timezone === 'string' ? documentMeta.timezone : null) ?? DEFAULT_DOCUMENT_TIME_ZONE)
          .toFormat((typeof documentMeta.dateFormat === 'string' ? documentMeta.dateFormat : null) ?? DEFAULT_DOCUMENT_DATE_FORMAT),
        inserted: true,
      };
    })
