...
import { ApiContractV1 } from "@signtusk/api/v1/contract";
import { ApiContractV1Implementation } from "@signtusk/api/v1/implementation";
import { OpenAPIV1 } from "@signtusk/api/v1/openapi";
import { testCredentialsHandler } from "@signtusk/lib/server-only/public-api/test-credentials";
import { listDocumentsHandler } from "@signtusk/lib/server-only/webhooks/zapier/list-documents";
import { subscribeHandler } from "@signtusk/lib/server-only/webhooks/zapier/subscribe";
import { unsubscribeHandler } from "@signtusk/lib/server-only/webhooks/zapier/unsubscribe";
...
tsRestHonoApp
  .get("/openapi", (c) => c.redirect("https://openapi-v1..com"))
