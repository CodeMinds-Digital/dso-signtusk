    ...
    <>
      ...
      <Section>
        ...
        <Text className="my-1 text-center text-base text-slate-400">
          {match(role)
            ...
            .with(RecipientRole.VIEWER, () => (
              <Trans>Continue by viewing the document.</Trans>
            ))
            .with(RecipientRole.APPROVER, () => (
              <Trans>Continue by approving the document.</Trans>
            ))
        ...
        <Section className="mb-6 mt-8 text-center">
          <Button
            className="bg-signtusk-500 text-sbase inline-flex items-center justify-center rounded-lg px-6 py-3 text-center font-medium text-black no-underline"
            href={signDocumentLink}
          >
            {match(role)
              .with(RecipientRole.SIGNER, () => (
                <Trans>View Document to sign</Trans>
              ))
              .with(RecipientRole.VIEWER, () => <Trans>View Document</Trans>)
              .with(RecipientRole.APPROVER, () => (
                <Trans>View Document to approve</Trans>
              ))
              .with(RecipientRole.CC, () => "")
              .with(RecipientRole.ASSISTANT, () => (
                <Trans>View Document to assist</Trans>
              ))
              .exhaustive()}
          </Button>
        </Section>
