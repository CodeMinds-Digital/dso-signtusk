/**
 * Simple document created from direct template email without React hooks.
 */
import {
  Body,
  Button,
...
export type DocumentCreatedFromDirectTemplateSimpleProps = {
...
export const DocumentCreatedFromDirectTemplateSimple = ({
  recipientName,
  documentName,
  documentLink,
  ...
  translations,
  branding,
}: DocumentCreatedFromDirectTemplateSimpleProps) => {
...
export default DocumentCreatedFromDirectTemplateSimple;
