/**
 * Simple document pending email template without React hooks.
...
export type DocumentPendingEmailSimpleProps = {
  documentName: string;
  assetBaseUrl: string;
  translations: {
    previewText: string;
...
export const DocumentPendingEmailSimple = ({
  documentName,
  assetBaseUrl = "http://localhost:3002",
  translations,
  branding,
}: DocumentPendingEmailSimpleProps) => {
...
export default DocumentPendingEmailSimple;
