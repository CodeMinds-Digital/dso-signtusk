/**
 * Simple recipient removed from document email without React hooks.
 */
import {
  Body,
  Container,
...
export type RecipientRemovedFromDocumentSimpleProps = {
  inviterName: string;
  documentName: string;
  assetBaseUrl: string;
  translations: {
...
export const RecipientRemovedFromDocumentSimple = ({
  inviterName,
  documentName,
  assetBaseUrl = "http://localhost:3002",
  translations,
  branding,
}: RecipientRemovedFromDocumentSimpleProps) => {
...
export default RecipientRemovedFromDocumentSimple;
