/**
 * Simple recipient signed email template without React hooks or Tailwind.
...
export type RecipientSignedEmailSimpleProps = {
  documentName: string;
...
export const RecipientSignedEmailSimple = ({
  assetBaseUrl,
  translations,
  branding,
}: RecipientSignedEmailSimpleProps) => {
...
export default RecipientSignedEmailSimple;
