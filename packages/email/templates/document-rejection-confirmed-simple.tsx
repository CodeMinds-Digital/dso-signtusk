/**
 * Simple document rejection confirmed email template without React hooks or Tailwind.
...
export type DocumentRejectionConfirmedEmailSimpleProps = {
...
export const DocumentRejectionConfirmedEmailSimple = ({
  assetBaseUrl,
  translations,
  branding,
}: DocumentRejectionConfirmedEmailSimpleProps) => {
...
export default DocumentRejectionConfirmedEmailSimple;
