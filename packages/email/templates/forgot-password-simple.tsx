/**
 * Simple forgot password email template without React hooks or Tailwind.
...
export type ForgotPasswordEmailSimpleProps = {
...
export const ForgotPasswordEmailSimple = ({
  resetPasswordLink,
  assetBaseUrl,
  translations,
}: ForgotPasswordEmailSimpleProps) => {
...
export default ForgotPasswordEmailSimple;
