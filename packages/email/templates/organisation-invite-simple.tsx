/**
 * Simple organisation invite email template without React hooks or Tailwind.
...
export type OrganisationInviteEmailSimpleProps = {
...
export const OrganisationInviteEmailSimple = ({
  inviteLink,
  assetBaseUrl,
  translations,
  branding,
}: OrganisationInviteEmailSimpleProps) => {
...
export default OrganisationInviteEmailSimple;
