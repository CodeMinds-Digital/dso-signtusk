/**
 * Simple document rejected email template without React hooks or Tailwind.
...
export type DocumentRejectedEmailSimpleProps = {
...
export const DocumentRejectedEmailSimple = ({
  documentName,
  documentUrl,
  assetBaseUrl,
  translations,
  branding,
}: DocumentRejectedEmailSimpleProps) => {
...
export default DocumentRejectedEmailSimple;
