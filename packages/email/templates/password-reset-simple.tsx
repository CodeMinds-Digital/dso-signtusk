/**
 * Simple password reset email template without React hooks or Tailwind.
...
export type PasswordResetEmailSimpleProps = {
  userName?: string;
  userEmail: string;
  assetBaseUrl: string;
  translations: {
...
export const PasswordResetEmailSimple = ({
  assetBaseUrl,
  translations,
  branding,
}: PasswordResetEmailSimpleProps) => {
...
export default PasswordResetEmailSimple;
