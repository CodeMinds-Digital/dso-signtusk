/**
 * Simple team deleted email template without React hooks or Tailwind.
...
export type TeamDeletedEmailSimpleProps = {
  teamName: string;
  teamUrl: string;
  baseUrl: string;
  assetBaseUrl: string;
...
export const TeamDeletedEmailSimple = ({
  assetBaseUrl,
  translations,
  branding,
}: TeamDeletedEmailSimpleProps) => {
...
export default TeamDeletedEmailSimple;
