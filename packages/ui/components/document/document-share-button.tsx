...
import { useCopyShareLink } from '@signtusk/lib/client-only/hooks/use-copy-share-link';
import { NEXT_PUBLIC_WEBAPP_URL } from '@signtusk/lib/constants/app';
import { generateTwitterIntent } from '@signtusk/lib/universal/generate-twitter-intent';
  ...
  const onTweetClick = async () => {
    ...
    window.open(
      generateTwitterIntent(
        `I just ${token ? 'signed' : 'sent'} a document in style with @signtusk. Check it out!`,
