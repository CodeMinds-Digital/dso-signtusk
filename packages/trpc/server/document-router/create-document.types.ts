...
import { ZDocumentMetaCreateSchema } from '@signtusk/lib/types/document-meta';
import { ZDocumentVisibilitySchema } from '@signtusk/lib/types/document-visibility';
